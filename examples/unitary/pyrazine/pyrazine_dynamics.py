...
import qdynos as qd
#import sys
#sys.path.append('/Users/addisonschile/Software/qdynos')
#from qdynos.hamiltonian import Hamiltonian
#from qdynos.bath import DebyeBath
...
def main():
  ...
  # unitary evolution
  ham      = qd.Hamiltonian(H, nstates=500, units='ev')
  dynamics = qd.UnitaryWF(ham)
  results  = qd.Results(tobs=tobs, e_ops=[p1,p2], print_es=True, es_file='db_pops_unitary_ntrunc_500.txt')
  output   = dynamics.solve(psi_0, times, results=results)
