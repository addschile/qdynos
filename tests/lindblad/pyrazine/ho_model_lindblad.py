...
def main(argv):
    ...
    es_file = 'pyr2_lindblad.dat'
    results = Results(tobs=tobs,e_ops=[p1,p2], print_es=True, es_file=es_file)
    output = dynamics.solve(rho, times, np.array([0.1,0.1]), [qt,qc], eig=True, results=results)
