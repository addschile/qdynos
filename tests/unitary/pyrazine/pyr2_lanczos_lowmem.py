...
def main():
    ...
    output = dynamics.solve(psi0, times, options=Options(method='lanczos', lanczos_lowmem=True), results=Results(tobs=len(times), e_ops=[p1,p2,p1+p2], print_es=True, es_file='pyr2_lanczos_lowmem.txt'))
